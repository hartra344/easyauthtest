...
namespace BlazorApp1.Controllers
{
    ...
    public class SseController : ControllerBase
    {
        ...
        public SseController(EasyAuthService easyAuthService)
        {
        ...
        public async Task StreamEvents()
        {
            ...
            // Get authentication info if needed
            var authInfo = _easyAuthService.GetEasyAuthInfo();
            var userName = authInfo?.PrincipalName ?? "Anonymous";
            
            // Define the events to send
            var events = new[]
            {
                new { id = "1751073677430", data = $@"{{""jsonrpc"":""2.0"",""id"":1,""result"":{{""kind"":""status-update"",""taskId"":""9fd47b2a-ac7a-4231-bd3b-864e7edcfc3b"",""contextId"":""c37b1a58-9075-4873-8b61-e2a14486d945"",""status"":{{""state"":""working"",""message"":{{""kind"":""message"",""role"":""agent"",""messageId"":""333980ed-56d0-45a7-8661-32d65536fbc6"",""parts"":[{{""kind"":""text"",""text"":""Hello {userName}""}}],""taskId"":""9fd47b2a-ac7a-4231-bd3b-864e7edcfc3b"",""contextId"":""c37b1a58-9075-4873-8b61-e2a14486d945""}},""timestamp"":""2025-06-28T01:21:17.430Z""}},""final"":false}}}}" },
                new { id = "1751073678245", data = @"{""jsonrpc"":""2.0"",""id"":1,""result"":{""kind"":""status-update"",""taskId"":""9fd47b2a-ac7a-4231-bd3b-864e7edcfc3b"",""contextId"":""c37b1a58-9075-4873-8b61-e2a14486d945"",""status"":{""state"":""completed"",""message"":{""kind"":""message"",""role"":""agent"",""messageId"":""2df2b9c6-fb51-4517-8628-55b5ef95bb08"",""parts"":[{""kind"":""text"",""text"":""How Is your day?.""}],""taskId"":""9fd47b2a-ac7a-4231-bd3b-864e7edcfc3b"",""contextId"":""c37b1a58-9075-4873-8b61-e2a14486d945""},""timestamp"":""2025-06-28T01:21:18.245Z""},""final"":true}}" }
            };
